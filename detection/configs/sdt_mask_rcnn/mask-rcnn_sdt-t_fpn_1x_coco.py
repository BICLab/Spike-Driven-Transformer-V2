...
# pretrained = "/lxh/checkpoint-199.pth" #55Mimagenet模型
# pretrained = "/lxh/checkpoint-15M.pth"  #15Mimagenet模型
...
model = dict(
    ...
    backbone=dict(
        ...
        # embed_dim=[128, 256, 512, 640],  #55m通道数
        embed_dim=[64, 128, 256, 360],  #15M通道数
        num_heads=8,
        mlp_ratios=4,
        in_channels=3,
        qkv_bias=False,
