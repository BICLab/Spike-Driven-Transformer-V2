...
class BaseDenseHead(BaseModule, metaclass=ABCMeta):
    ...
    def predict(self,
        ...
        outs = self(x)  #这部分对应rpn_cls，rpn_reg  输入五个层特征，得到五个层3/12的结果

        predictions = self.predict_by_feat(  #输入五个层3/12的结果，得到1000个得分
    ...
    def predict_by_feat(self,
        ...
        return result_list  #得到1000个类别得分，以及4000个回归框位置
